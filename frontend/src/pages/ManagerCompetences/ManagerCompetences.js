...
const ManagerCompétences = () => {
  ...
  return (
    <div className="domaines-Manager-page">
      ...
      <h2 className="title-Manager-page">Gestion des Compétences</h2>
      <MdOutlineContentPasteSearch className="icon-Manager-page" />
      <div className="button-container">
        <button className="add-domain-button" onClick={handleAddSkill}>
...
export default ManagerCompétences;
