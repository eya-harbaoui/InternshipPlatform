...
module.exports = {
    ...
    createUser: async (req, res) => {
        try {
            ...
            const newUser = new User({
                firstName, lastName, email, password: hashedPassword, phoneNumber, role
            });
            await newUser.save();
    ...
    login: async (req, res) => {
        try {
            ...
            const token = jwt.sign({ userId: user._id , role : user.role }, process.env.JWT_SECRET_KEY, { expiresIn: Date.now() + process.env.EXPIRE });
